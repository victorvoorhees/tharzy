    ...
    return (
        <div className={Styles.master}>
            ...
            <div className={Styles.content}>
                ...
                <div className='p-2'>
                    ...
                    <div className={Styles.list}>
                        <div>1</div>
                        <div>
                            <p>Content that opposes the democratic will of the people of Myanmar and their resistance against Tatmadaw.</p>
                            <p>Examples include supporting Tatmadaw or agreeing with their actions, cheering or making fun of the troubles of civilians and resistance forces, justifying the Rohingya genocide, supporting specific actions by other countries that benefit Tatmadaw (such as supporting Russia's decision to supply arms to Tatmadaw), and so on.</p>
                        </div>
                    </div>
                    <div className={Styles.list}>
                        <div>2</div>
                        <div>
                            <p>Content that is extremely disrespectful towards one's race, ethnicity, skin color, gender and sexual orientation, social class, and nationality.</p>
                            <p>Examples include labelling the Rohingyas as "illegal immigrants", wishing death and suffering on the civilians of Russia, China, USA, etc for the actions of their governments, and so on.</p>
                        </div>
                    </div>
                    <div className={Styles.list}>
                        <div>3</div>
            ...
            <div className={Styles.content}>
                ...
                <p className='p-2'>On the 1st of February last year, the Burmese military staged a coup against the democratically elected civilian government by detaining several members of it and effectively transferring the state power to themselves.</p>
            </div>
            <div className={Styles.content}>
